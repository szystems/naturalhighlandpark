...
<head>
    ...
    <title>Natural Highland Park</title>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 15px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
																														<div style="line-height: 150%; text-align: right;"><span style="font-size: 12px; font-family: 'Courier New', Courier; color: #ffffff; line-height: 150%;"><span style="text-decoration: underline; line-height: 150%;">
																															<a href="{{ url('/') }}"><p class="site"><font color="white">www.naturalhighlandpark.com</font></p></a></span></span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="bmeImage" style="border-collapse: collapse; padding: 20px;"><a href="{{ url('/') }}"><img src="{{asset('hltemplate/images/logo/logo.png')}}" alt="Highland Natural Park" height="100"></a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;"><span style="font-size: 16px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;"><strong>Se a creado o modificado una reservación que solicitaste en Highland Natural Park por favor revisa los datos completos de la misma ingresando en el link de abajo y entra a tu cuenta o busca la reservación con el código de reservación que se te proporciona a continuación: </font></strong></span>
                                                                                                                            <ul>
                                                                                                                                <li>Nombre: {{ $cli->name }}</li>
                                                                                                                                <li>Teléfono: {{ $cli->telefono }}</li>
                                                                                                                                <li>Email: {{ $cli->email }}</li>
                                                                                                                                <li>No. Documento: {{ $cli->num_documento }}</li>
                                                                                                                                <?php
                                                                                                                                    $fecha = date("d-m-Y", strtotime($reserva->fecha));
                                                                                                                                ?>
                                                                                                                                <li>Fecha Reservacion: {{ $fecha }}</li>
                                                                                                                                <li>Codigo Código: {{ $reserva->codigo }}</li>
                                                                                                                                <li>Estado Reservacion: {{ $reserva->estado_reservacion }}</li>
                                                                                                                                <li>Abonado: {{ $usures->moneda }}{{ number_format($reserva->abonado,2, '.', ',') }}</li>
                                                                                                                                <li>Total: {{ $usures->moneda }}{{ number_format($reserva->total,2, '.', ',') }}</li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Ve al siguiente enlace y coloca el código de reserva para verificar el estado de la misma:</span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                    ...
                                                                                                                    <td valign="top" name="bmeSocialTD" class="bmeSocialTD">
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">
                                                                                                                                        <a href="https://www.facebook.com/HighlandNaturalPark/" target=_blank style="display: inline-block;background-color: rgb(0, 174, 84);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('hltemplate/images/redes/Fb.png')}}" alt="Facebook" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                        ...
                                                                                                                        <table cellspacing="0" cellpadding="0" border="0" class="bmeFollowItem" type="Instagram" style="float: left; display: block;" align="left">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="padding-right:20px;height:20px;">
                                                                                                                                        <a href="https://www.instagram.com/naturalhiglandpark/" target=_blank style="display: inline-block;background-color: rgb(0, 174, 84);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('hltemplate/images/redes/Insta.png')}}" alt="Instagram" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td align="left" class="bmeFollowItemIcon" gutter="20" width="24" style="height:20px;">
                                                                                                                                        <a href="" target=_blank style="display: inline-block;background-color: rgb(0, 174, 84);border-radius: 0px;border-style: none; border-width: 0px; border-color: rgba(0, 0, 0, 0);" target="_blank"><img src="{{asset('hltemplate/images/redes/Insta.png')}}" alt="Youtube" style="display: block; max-width: 114px;" border="0" width="24" height="24"></a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        </table>
