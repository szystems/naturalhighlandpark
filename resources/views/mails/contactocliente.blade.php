                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;"><span style="font-size: 16px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;"><strong>Tienes un nuevo correo de contacto desde enviado desde la pagina de www.naturalhighlandpark.com, la información enviada es la siguiente:</font></strong></span>
                                                                                                                            <ul>
                                                                                                                                <li>Nombre: {{ $nombre }}</li>
