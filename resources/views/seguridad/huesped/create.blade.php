...
<div class="col-md-6 mb-4">
      <div class="card">
            <header class="card-header">
                  <h2 class="h3 card-header-title"><strong>Crear Huésped </strong></h2>
            </header>
            ...
            <div class="card-body">
                  ...
                  {!!Form::open(array('url'=>'seguridad/huesped','method'=>'POST','autocomplete'=>'off'))!!}
                  {{Form::token()}}
                  ...
                  <div class="form-group{{ $errors->has('tipo_usuario') ? ' has-error' : '' }}">
                        ...
                        <select id="tipo_usuario" type="text" class="form-control" name="tipo_usuario" value="{{ old('tipo_usuario') }}">
                              <option selected="selected" value="Huesped">Huesped</option>   
                        </select>
