		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                {{Form::token()}}
					...
					<div class="card mb-4">
						<header class="card-header d-md-flex align-items-center">
							<h4><strong>Imprimir Listado de Huéspedes </strong></h4>
				...
				{{Form::close()}}
				@include('seguridad/huesped.search')
		               ...
		               @foreach ($usuarios as $usu)
						<tr>
							<td>
								...
								<a href="{{URL::action('HuespedController@show',$usu->id)}}">
								...
								<a href="{{URL::action('HuespedController@edit',$usu->id)}}">
						...
						@include('seguridad.huesped.modal')
						@endforeach
					</table>
				</div>
				{{$usuarios->render()}}
