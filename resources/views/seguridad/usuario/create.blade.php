      ...
      <div class="card">
            ...
            <div class="card-body">
                  ...
                  <div class="form-group{{ $errors->has('departamento') ? ' has-error' : '' }}">
                        ...
                        <input id="departamento" type="text" class="form-control" name="departamento" value="{{ old('departamento') }}" placeholder="Departamento ">
                  ...
                  <div class="form-group{{ $errors->has('tipo_administrador') ? ' has-error' : '' }}">
                        ...
                        <select id="tipo_administrador" type="text" class="form-control" name="tipo_administrador" value="{{ old('tipo_administrador') }}">
                              <option selected="selected" value="Total">Total</option>  
                              <option value="Recepcionista">Recepcionista</option>    
                        </select>
                        @if ($errors->has('tipo_adminstrador'))
                              <span class="help-block">
                                    <strong>
