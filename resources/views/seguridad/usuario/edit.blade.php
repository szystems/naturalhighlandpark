      ...
      <div class="card">
            ...
            <div class="card-body">
                  ...
                  <div class="form-group{{ $errors->has('pais') ? ' has-error' : '' }}">
                        <label for="pais">País</label>
                                                <select name="pais" class="form-control" required>
                                                    <option selected value="{{$usuario->pais}}">{{$usuario->pais}}</option>
                  ...
                  <div class="form-group{{ $errors->has('departamento') ? ' has-error' : '' }}">
                        ...
                        <input id="departamento" type="text" class="form-control" name="departamento" value="{{$usuario->departamento}}">
                  ...
                  <div class="form-group{{ $errors->has('num_documento') ? ' has-error' : '' }}">
                        ...
                        <input id="num_documento" type="text" class="form-control" name="num_documento" value="{{$usuario->num_documento}}">
                  ...
                  <div class="form-group{{ $errors->has('tipo_administrador') ? ' has-error' : '' }}">
                        <label for="tipo_administrador"><font color="orange">*</font>Tipo de Administrador</label>
                        <select id="tipo_administrador" type="text" class="form-control" name="tipo_administrador" value="{{$usuario->tipo_administrador}}">
                            <option selected="selected" value="{{$usuario->tipo_administrador}}">{{$usuario->tipo_administrador}}</option>  
                            <option value="Total">Total</option>   
                            <option value="Recepcionista">Recepcionista</option>  
                        </select>
                        @if ($errors->has('tipo_administrador'))
                              <span class="help-block">
                                    <strong>
                                          {{ $errors->first('tipo_administrador') }}
                                    </strong>
                              </span>
                        @endif
                  </div>  
                  @else
                        <input id="tipo_administrador" type="hidden" class="form-control" name="tipo_administrador" value="{{$usuario->tipo_administrador}}">
                  @endif
            </div>
            ...
            <footer class="card-footer">
                  <div class="form-group">
                        ...
                        <input id="idcliente" type="hidden" class="form-control" name="idcliente" value="{{$usuario->idcliente}}">
