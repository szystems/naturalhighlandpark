			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
						<span class="icon">
							<img src="{{asset('hltemplate/images/atracciones/Bistroweb.png')}}" alt="Facebook" width="300" height="300">
						</span>
						<span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span>
						<h2>Menu Tzununah Bistro</h2>
					...
					<div class="diningbar-flex">
						<div class="half animate-box">
							<ul class="nav nav-tabs text-center" role="tablist">
								<li role="presentation" class="active"><a href="#mains" aria-controls="mains" role="tab" data-toggle="tab">Tzununah Bistro</a></li>
								<!--<li role="presentation"><a href="#desserts" aria-controls="desserts" role="tab" data-toggle="tab">Casa Antonieta</a></li>-->
							</ul>
			            <!-- Tab panes -->
										...
										<div class="col-md-12">
											...
											<li>
												<p>
													...
													<iframe   width="100%" height="800" src="https://www.naturalhighlandpark.com/menus/Menu_Tzununah_Bistro.pdf"></iframe>
												</p>
											</li>
											<!--<li>
