			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box">
                        ...
                        <!-- fin .flash-message -->
                        <h3>Datos de Huesped</h3>
                        
                        <div class="card">
                            <header class="card-header">
                                <h2 class="h3 card-header-title"><strong>Editar Huésped: {{ $usuario->name}} </strong></h2>
                            </header>
                            ...
                            <div class="card-body">
                                ...
                                {!!Form::model($usuario,['method'=>'PATCH','route'=>['vhuesped.update',$usuario->id]])!!}
                                {{Form::token()}}
                                ...
                                <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                                        <label for="telefono"><font color="orange">*</font>Teléfono</label>
                                        <input id="telefono" type="text" class="form-control" name="telefono" value="{{$usuario->telefono}}" required>
                                ...
                                <div class="form-group{{ $errors->has('pais') ? ' has-error' : '' }}">
                                        <label for="pais"><font color="orange">*</font>País</label>
                                ...
                                <div class="form-group{{ $errors->has('tipo_usuario') ? ' has-error' : '' }}">
                                        ...
                                        <select id="tipo_usuario" type="hidden" class="form-control" name="tipo_usuario" value="{{$usuario->tipo_usuario}}">
