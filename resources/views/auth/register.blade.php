                            ...
                            <div class="u-login-form">
                                <form class="mb-3" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="small">Llena con tus datos el formulario siguiente y presiona el boton de Registrarse. Datos con (*) son obligatorios.</p>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-4">
                                                ...
                                                <input id="departamento" type="text" class="form-control" name="departamento" placeholder="Departamento/Estado..." required>
                                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-4{{ $errors->has('password') ? ' has-error' : '' }}">
                                                ...
                                                <input id="direccion" class="form-control" name="direccion" type="text" placeholder="Tu Dirección...">
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-4">
                                                ...
                                                <input id="num_documento" type="text" class="form-control" name="num_documento" placeholder="Numero de documento/ pasaporte / dpi / etc..." required>
                                            </div>
